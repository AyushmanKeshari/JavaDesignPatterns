package StructuralDesignPatterns.CompositePattern.Expenses_Problem;
...
public class ExpensesClient {
  ...
  //Below three are same (Paying Expenses), just passing object is different.
  //Treat manager, salesperson, team as ExpensesClient
